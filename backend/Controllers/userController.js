import { catchAsyncErrors } from "../Middlewares/getAsyncErrors.js";
...
export const login = catchAsyncErrors(async (req, res, next) => {
  ...
  if (password !== confirmPassword) {
    return next(
      new ErrorHandler("Password And Confirm Pasword Do Not Match!", 400)
    );
  }
...
export const addNewDoctor = catchAsyncErrors(async (req, res, next) => {
  if (!req.files || Object.keys(req.files).length === 0) {
    return next(new ErrorHandler("Doctor Avatar Requried!", 400));
  }
